...
import archive.coke.Coca_ColaFactory;
import archive.coke.CokeFactory;
import archive.coke.PepsiFactory;
import archive.company.Coca_ColaCompany;
import archive.company.PepsiCompany;
import archive.customer.Order;
import archive.customer.OrderBuidler;
import archive.message.Message;
import archive.message.Recipient;
//程序运行时呈现的窗体
public class CilentFrame extends JFrame implements ActionListener{
