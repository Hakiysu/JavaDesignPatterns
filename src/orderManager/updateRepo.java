...
public class updateRepo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String updateSql = "update goodstatus set goodAmount = '" + goodAmount + "', goodPrice = '" + goodPrice + "' where goodID = '" + goodID + "'";
            sql.executeUpdate(updateSql);
            out.print("<script language='javascript'>alert('订单已提交！跳转到新建订单页面继续下单。');window.location.href='/clientFrame/repoManager.jsp';</script>");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
